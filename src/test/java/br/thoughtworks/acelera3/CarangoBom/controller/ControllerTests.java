...
public abstract class ControllerTests {
	...
	protected String getMockWithToken(String path, TokenDto token) throws UnsupportedEncodingException, Exception {
		return mockMvc.perform(MockMvcRequestBuilders.get(uri + path)
